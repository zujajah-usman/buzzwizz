                      ...
                      foreach($stmt as $row){
                        echo "
                          <tr>
                            ...
                            <td>".escape_html($row['quantity'])."</td>
                            <td>
                              <button class='btn btn-success btn-sm edit btn-flat' data-id='".escape_html($row['cartid'])."'><i class='fa fa-edit'></i> Edit Quantity</button>
                              <button class='btn btn-danger btn-sm delete btn-flat' data-id='".escape_html($row['cartid'])."'><i class='fa fa-trash'></i> Delete</button>
                            </td>
                          </tr>
                        ";
                      }
