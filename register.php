		...
		if($password != $repassword){
			...
			if($row['numrows'] > 0){
				...
				try{
					...
					// SECURITY: Don't send password in email
					$message = "
						<h2>Thank you for Registering.</h2>
						<p>Your Account:</p>
						<p>Email: ".escape_html($email)."</p>
				    ...
				    try {
				        ...
				        // SECURITY: Password should be stored in environment variable or config file
				        // For production, use: $mail->Password = getenv('SMTP_PASSWORD') ?: '';
				        $mail->Password = getenv('SMTP_PASSWORD') ?: 'mysourcepass'; // TODO: Move to environment variable                    
