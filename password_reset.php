...
<div class="login-box">
    ...
    ?>
  	<div class="login-box-body">
    	...
    	<form action="password_new.php?code=<?php echo htmlspecialchars($_GET['code'] ?? '', ENT_QUOTES, 'UTF-8'); ?>&user=<?php echo htmlspecialchars($_GET['user'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" method="POST">
